...
class DebugScanner:
    ...
    async def run(self, barcode: str, lapin_id: str = "lapin_healthy") -> DebugScanResult:
        ...
        print("  -> Agence Besoins (appel Gemini, attend 10-20s)...")
        ...
        print("  -> Agent Personnel (profil lapin + Gemini)...")
        ...
        print("  -> Agent Produit (OpenFoodFacts + Gemini + Web Search, attend 30-60s)...")
        ...
        print("  -> Agent Comparateur (cross-ref + scoring, attend 30-60s)...")
